...
**Goal:** Map how information moves through the system — concretely enough to scope and spec the POC. (The deep version — trimming LLM calls, schemas — comes later in the agent_behavior workflow.)
...
That's enough to scope and spec. You'll inventory and tighten the actual LLM calls and data flow in the later agent_behavior workflow.
